...
| ------------- | ------------- |
| [How to Run](#how-to-run-these-two-scripts)   | Content Cell  |
| Content Cell  | [How to Run](#how-to-run-these-two-scripts)   |
...
### [Utility1.py](#utility1py)  
- [How to Run](#how-to-run)  
- [Command Line Arguments](#command-line-arguments-utility1)  
- [Test Cases](#test-cases-utility1)  
  - [Input](#input-utility1)  
  - [Output](#output-utility1)  
- [Troubleshooting](#troubleshooting-utility1)  

### [Utility2.py](#utility2py)  
- [Command Line Arguments](#command-line-arguments-utility2)  
- [Test Cases](#test-cases-utility2)
  - [Input Parameters](#input-parameters-utility1)  
  - [Output Results](#output-results-utility1)  
...
* Finally used a dictionary to keep track of items outside of it and the dict itself being independant of pending JSON trandsformation (the 'occurrences' variable in utility1.py)
...
```
  ...
  ```      
### Questions:
I noticed more tax forms are being added and currently the W-2 form is the only form that can have your data from last year parsed for P!nwheel clients. If not implemented already, will parsing user data for other tax form docs be availible soon?
